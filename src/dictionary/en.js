export const en = {
  ...
  detmir: {
    ...
    achievements: 'Responsibilities and achievements',
    a1: 'Completely reworked application\'s build process, moved from webpack 4 to webpack 5.',
    a2: 'Optimization of the building process frontend application\'s, it was possible to reduce the number of files by 10 times for node building, reduce the size of css files by 2 times, the size of js files by 10 times for node type of build.',
    a3: 'Server-side rendering system update: move from nodejs 10 to nodejs 14.',
    a4: 'Creation of transparent proxy of Google analytics and Yandex metrics - which led to an increase in statistics numbers and allowed to bypass ad blockers.',
