export const en = {
  ...
  detmir: {
    ...
    a3: 'Server-side rendering system update: translation to nodejs 14 from 10 version.',
    a4: 'Creation of transparent proxy of Google analytics and Yandex metrics - which led to an increase in statistics and allowed to bypass ad blockers.',
